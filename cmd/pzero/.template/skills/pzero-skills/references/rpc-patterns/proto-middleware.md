...
pzero supports adding middleware to proto services at multiple levels. Multiple middleware can be specified using comma separation.
...
After running `pzero gen`, the following files will be generated (using `auth` as an example):
...
// This file is auto-generated by pzero
