...
func (ja *PzeroApi) getAllLogicFiles(apiFilepath string, apiSpec *spec.ApiSpec) ([]LogicFile, error) {
...
func (ja *PzeroApi) patchLogic(file LogicFile, genCodeApiSpecMap map[string]*spec.ApiSpec) error {
