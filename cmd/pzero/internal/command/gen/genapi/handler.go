...
func (ja *PzeroApi) getAllHandlerFiles(apiFilepath string, apiSpec *spec.ApiSpec) ([]HandlerFile, error) {
...
func (ja *PzeroApi) patchHandler(file HandlerFile, genCodeApiSpecMap map[string]*spec.ApiSpec) error {
...
func (ja *PzeroApi) removeHandlerSuffix(f *ast.File) error {
...
func (ja *PzeroApi) compactHandler(f *dst.File, fset *token.FileSet, file HandlerFile) error {
