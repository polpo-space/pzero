...
import (
	...
	"github.com/polpo-space/pzero/cmd/pzero/internal/command/skills/skillsinit"
)
...
var initCmd = &cobra.Command{
	...
	Long:  `Initialize skills templates from cmd/pzero/.template/skills to the project root's .claude/skills directory.`,
